"""ROUND_3: trader_MOM — option wings listen to VELVET fair edge.
...
calibration fuel. Extra layer: OTM calls lean with underlying edge.
"""
...
class Trader:
    ...
    def trade_5300(self, state, result, S, vev_dir, spot_edge: float):
    ...
    def trade_5400(self, state, store, result, S, spot_edge: float):
    ...
    def trade_5500(self, state, store, result, S, basket_active: bool, spot_edge: float):
    ...
    def run(self, state: TradingState):
        ...
        self.trade_5300(state, result, S, vev_dir, spot_edge)
        self.trade_5400(state, store, result, S, spot_edge)
        self.trade_5500(state, store, result, S, basket_active, spot_edge)
