"""agent2 variant B: conservative wing-bot tilt for VEV_5200.

Same idea as variant A, but lower edge/longer TTL and tighter trigger.
"""
...
from ROUND_4 import trader_HYPER as hyper
