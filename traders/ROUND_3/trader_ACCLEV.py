...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        option_spot_edge = spot_edge + (8.0 if v_active else 0.0)
        self.trade_5000(state, store, result, S, option_spot_edge)
        self.trade_smile_atm(state, store, result, smile_lv, "VEV_5100", 5100, S, v_active, option_spot_edge)
        self.trade_smile_atm(state, store, result, smile_lv, "VEV_5200", 5200, S, v_active, option_spot_edge)
